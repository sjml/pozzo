<script lang="ts">
    ...
    router.subscribe(e => {console.log(e)});
</script>
...
<div class="container">
    ...
    <Router>
        ...
        <Route path="/setup" component={() => import("./SetupPage.svelte")} />

        <Route path="/album/:albumSlug" let:router>
            <AlbumIndex albumSlug={router.params.albumSlug} />
        </Route>
