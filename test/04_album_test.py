...
def test_album_previews(server):
    res = requests.post(
        server.api("/album/view/1"),
        json={"previews": 1}
    )
...
def test_nonexistent_album_is_nonexistent(server):
    res = requests.post(
...
def test_create_album_auth(server, auth):
    res = requests.post(
        server.api("/album/new")
    )
    assert res.status_code == 401

def test_create_album(server, auth):
    res = requests.post(
        server.api("/album/new"),
        headers=auth
    )
...
def test_album_unique_name(server, auth):
    res = requests.post(
        server.api("/album/new"),
        headers=auth,
        json={"title": "Test Album 1"}
...
def test_album_non_numeric_name(server, auth):
    res = requests.post(
        server.api("/album/new"),
        headers=auth,
        json={"title": "42"}
...
def test_copy_photos_auth(server):
    res = requests.post(
        server.api("/photo/copy")
    )
    assert res.status_code == 401

def test_copy_photos(server, auth):
    res = requests.post(
        server.api("/photo/copy"),
        headers=auth,
    )
...
def test_remove_photos_auth(server):
    res = requests.post(
        server.api("/album/remove")
    )
    assert res.status_code == 401

def test_remove_photos(server, auth):
    res = requests.post(
        server.api("/album/remove"),
        headers=auth
    )
...
def test_create_private_album(server, auth):
    res = requests.post(
        server.api("/album/new"),
        headers=auth,
...
def test_album_privacy(server, auth):
    res = requests.get(
...
def test_album_list_privacy(server, auth):
    res = requests.get(
        server.api("/album/list"),
    )
    assert res.status_code == 200
...
def test_album_metadata_auth(server):
    res = requests.post(
        server.api("/album/edit/2"),
    )
    assert res.status_code == 401

def test_album_metadata_empty(server, auth):
    res = requests.post(
        server.api("/album/new"),
        headers=auth,
...
def test_album_metadata(server, auth):
    res = requests.get(
...
def test_delete_album_auth(server):
    res = requests.post(
        server.api("/album/delete"),
    )
    assert res.status_code == 401

def test_delete_album(server, auth):
    res = requests.post(
        server.api("/album/delete"),
        headers=auth,
    )
...
def test_delete_nonexistent_album(server, auth):
    res = requests.post(
        server.api("/album/delete"),
        headers=auth,
        json={"albumID": 4}
...
def test_reorder_album_auth(server):
    res = requests.post(
...
def test_reorder_album_not_enough(server, auth):
    res = requests.post(
        server.api("/album/reorder/2"),
        headers=auth,
...
def test_reorder_album_bad_index(server, auth):
    res = requests.post(
        server.api("/album/reorder/2"),
        headers=auth,
...
def test_reorder_album_non_unique(server, auth):
    res = requests.post(
        server.api("/album/reorder/2"),
        headers=auth,
...
def test_reorder_album(server, auth):
    res = requests.post(
        server.api("/album/reorder/2"),
        headers=auth,
        json={"newOrdering": [5,4,3,2,1]}
...
def test_reorder_album_list_auth(server):
    res = requests.post(
...
def test_reorder_album_list_not_enough(server, auth):
    res = requests.post(
        server.api("/album/reorderList"),
        headers=auth,
...
def test_reorder_album_list_too_much(server, auth):
    res = requests.post(
        server.api("/album/reorderList"),
        headers=auth,
...
def test_reorder_album_list_bad_index(server, auth):
    res = requests.post(
        server.api("/album/reorderList"),
        headers=auth,
...
def test_reorder_album_list_non_unique(server, auth):
    res = requests.post(
        server.api("/album/reorderList"),
        headers=auth,
...
def test_reorder_album_list(server, auth):
    res = requests.post(
        server.api("/album/reorderList"),
        headers=auth,
        json={"newOrdering": [3,2,1]}
